   ...
   protected ForecastDataSource mDataSource;
    ...
    protected void onResume(){
        ...
        try {
            ...
            ForecastAdapter adapter = new ForecastAdapter(this, cursor, 0);
    ...
    protected void updateList(Cursor cursor){
        ...
        while (!cursor.isAfterLast()){
            int i = cursor.getColumnIndex(ForecastOpenHelper.COLUMN_TEMPERATURE);
            double temperature = cursor.getDouble(i);
            mTemperatures.add(new BigDecimal(temperature, MathContext.DECIMAL32));
            cursor.moveToNext();
        }
        ArrayAdapter<BigDecimal>adapter = new ArrayAdapter<BigDecimal>(this, R.layout.simple_list_item, mTemperatures);
